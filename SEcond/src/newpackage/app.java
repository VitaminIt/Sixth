...
round r1=new round(5.5);
		...
		System.out.println("Довжина нашого кола становить "+"2*pi*"+r1.getRadius()+" = "+r1.getLenght());
		System.out.println("Площа нашого круга становить "+"0.25*pi*"+r1.getDiameter()+" = "+r1.getSquare());
	}
